...
A userscript or browser add-on to enhance the Flickr experience in desktop web-browsers.
...
Available as an userscript and soon also as an "independent" browser add-on (webextension).
